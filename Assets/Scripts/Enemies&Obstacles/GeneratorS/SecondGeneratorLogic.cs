...
public class SecondGeneratorLogic : MonoBehaviour
{
    ...
    [SerializeField] CrateTwoUI sparePart;
    ...
    public float humMaxDistance = 50f;
    ...
    private void Start()
    {
        ...
        if (isSecondFixed) ApplyFixedState();
    ...
    private void Update()
    {
        if (inRange)
        {
            ...
            if (sparePart.partsCollectedTwo && !isSecondFixed)
            {
