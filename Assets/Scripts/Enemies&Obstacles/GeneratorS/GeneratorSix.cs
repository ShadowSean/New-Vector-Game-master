...
public class GeneratorSix : MonoBehaviour
{
    ...
    [SerializeField] CrateSixUI sparePart;
    ...
    private void Start()
    {
        ...
        if (isSixthFixed) ApplyFixedState();
    ...
    private void Update()
    {
        if (inRange)
        {
            ...
            if (sparePart.partsCollectedSix && !isSixthFixed)
            {
    ...
    public bool GetFixedState() => isSixthFixed;
